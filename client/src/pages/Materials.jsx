  ...
  return (
    <div className="p-8 space-y-6 max-w-7xl mx-auto animate-in fade-in duration-300">
      <div className="flex items-center justify-between pb-4 border-b border-gray-200 dark:border-[#181a1f]">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Υλικά</h1>
        ...
        {loading ? (
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-[#181a1f]">
              {materials.length === 0 ? (
                <tr><td colSpan="5" className="px-8 py-12 text-center text-gray-500 dark:text-gray-400">Δεν βρέθηκαν υλικά</td></tr>
              ) : (
                materials.map((m, i) => (
