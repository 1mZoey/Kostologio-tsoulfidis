...
export default function Calculator() {
  ...
  const vatAmount = hasMargin
    ? sellingPriceNoTax * 0.24
    : (result?.vatAmount ?? 0);
        ...
        <div className='space-y-5'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
            ...
            <div>
              ...
              <div className='flex gap-0 bg-gray-50 dark:bg-[#21252b] rounded-xl'>
                {["παλέτα", "κιβώτιο"].map((opt) => (
                  <button
                    key={opt}
                    type='button'
                    onClick={() => setPackaging(opt)}
                    className={`flex-1 py-3 px-4 rounded-xl border-2 text-sm font-medium capitalize transition-all bg-gray-50 dark:bg-[#21252b]
                    ${
                      packaging === opt
                        ? "border-gray-900 dark:border-white text-gray-900 dark:text-white"
                        : "border-gray-50 dark:border-[#21252b] text-gray-400 dark:text-gray-500 hover:border-gray-50 dark:hover:border-[#21252b] hover:text-gray-600 dark:hover:text-white"
                    }`}
                  >
                    {opt}
                  </button>
            ...
            {result.isTradeGood && (
              <div className='mb-2 px-3 py-2 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800'>
                <p className='text-xs text-amber-700 dark:text-amber-400 font-medium'>
                  Εμπορικό Είδος — Τιμή Πώλησης χωρίς παραγωγή
                </p>
              </div>
            )}
            ...
            <div className='space-y-3 text-sm text-gray-600 dark:text-gray-400'>
                ...
                <div className='flex justify-between items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-[#2c313c]/50 transition-colors'>
                  ...
                  <span className='font-medium text-gray-900 dark:text-gray-200'>
                    <span className='text-gray-400'>
                      €{fmt(result.breakdown.baseCostPerM2)}/m²
                    </span>
                  </span>
                </div>
              )}
              ...
              {result.isTradeGood ? (
                <div className='flex justify-between items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-[#2c313c]/50 transition-colors'>
                  ...
                  <span className='font-medium text-gray-900 dark:text-gray-200'>
                    <span className='text-gray-400'>
                      €{fmt(result.breakdown.sellingPricePerM2)}/m²
                    </span>
                  </span>
                </div>
              ) : (
                <div>
                  <div
                    ...
                    onClick={() =>
                      hasMachineBreakdown && setShowMachineBreakdown((v) => !v)
                    }
                  >
              ...
              {result.breakdown.packagingPerM2 > 0 && (
                <div className='flex justify-between items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-[#2c313c]/50 transition-colors'>
                  ...
                  <span className='font-medium text-gray-900 dark:text-gray-200'>
                    <span className='text-gray-400'>
                      €{fmt(result.breakdown.packagingPerM2)}/m²
                    </span>
                  </span>
                </div>
              )}
            ...
            <div className='space-y-3 text-sm text-gray-600 dark:text-gray-400'>
              ...
              {result.breakdown.packagingFlatFee > 0 && (
                <div className='flex justify-between items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-[#2c313c]/50 transition-colors'>
                  ...
                  <span className='font-medium text-gray-900 dark:text-gray-200'>
                    <span className='text-gray-400'>
                      €{fmt(result.breakdown.packagingFlatFee)}
                    </span>
                  </span>
                </div>
              )}
              ...
              {result.breakdown.pressingFlatFee > 0 && (
                <div className='flex justify-between items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-[#2c313c]/50 transition-colors'>
                  ...
                  <span className='font-medium text-gray-900 dark:text-gray-200'>
                    <span className='text-gray-400'>
                      €{fmt(result.breakdown.pressingFlatFee)}
                    </span>
                  </span>
                </div>
              )}
